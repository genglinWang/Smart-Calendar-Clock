...
Pls note that my PCB board is powered by common 5V chargers, i.e. mobile phone chargers, and USB-DC005 cable. Since DC005 is uncommon, you can change the power interface into type-c, micro or USB, just using your phone charger and cable to power the PCB board (except for Apple users:joy:).

My schematic was selected and shown in the teaching PowerPoint of Open-Innovation-1 in 2023 Spring.:stuck_out_tongue_closed_eyes::heart:
