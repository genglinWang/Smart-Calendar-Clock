...
//sbit LCD12864_DA_PORT = P0 ;

//sbit LCD12864_RS_PORT = P2 ^ 3;
...
//	LCD12864_RW_PORT = 1;
//	LCD12864_E_PORT = 1;
//	while((LCD12864_DA_PORT & 0x01)==1); /*等待BF 不为1*/
//	LCD12864_E_PORT = 0;
//	for(i=0;i<5;i++);
//}
...
//		{
//		
//		LCD12864_COM_Write(0x80);			//设置指针，第一行
//		LCD12864_write_word("202020120236");	
//		LCD12864_COM_Write(0x90);			//设置指针，第二行
//		LCD12864_write_word("202020120236");	
//		LCD12864_COM_Write(0x88);			//设置指针，第三行
//		LCD12864_write_word("202020120236");	
//		LCD12864_COM_Write(0x98);			//设置指针，第四行
